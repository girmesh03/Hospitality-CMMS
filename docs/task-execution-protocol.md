...
When the user approved or allowed you to proceed Step 6:
- Before you to proceed to Step 6

**Document The Implementation Phase results**:
	- Create `docs/phase-<N>-<name>.md` documenting every single detail
	- Exhaustively include any change made with respect to the initial requirements and design insisted by the user (if there any on the curet implementation phase or from a very first implementation phase upto the Current). The change must be respected in future implementation phases.
