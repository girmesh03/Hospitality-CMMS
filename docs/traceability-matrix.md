...
## Phase 03.5 Bootstrap Addition

| Decision area                  | Source basis                                                                           | Locked outcome                                                                                                           | Impacted phases  |
| ------------------------------ | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| System bootstrap mechanism     | `docs/prd.md` `20`, `docs/requirements.md` `8.0`, `docs/design.md` `4.1.5` and `5.1.5` | Bootstrap endpoint `POST /api/v1/bootstrap/initialize` creates first organization and Super_Admin user atomically        | 03.5, 04, 05, 18 |
| Bootstrap availability         | `docs/prd.md` `20.2.1`                                                                 | Bootstrap endpoint only accessible when organization count is zero, returns 409 if organization exists                   | 03.5, 04         |
| Bootstrap admin verification   | `docs/prd.md` `20.2.3`, `20.3.3`                                                       | Bootstrap admin user is pre-verified (`emailVerified: true`), no email verification required                             | 03.5, 04         |
| Bootstrap implementation phase | `docs/prd.md` `20.5`, `docs/tasks.md` Phase 03.5                                       | Bootstrap implemented in Phase 03.5 (after infrastructure, before authentication) to enable end-to-end auth testing      | 03.5, 04         |
| Bootstrap vs mock data         | `docs/prd.md` `20.7`                                                                   | Bootstrap is production mechanism (Phase 03.5), mock data is development/demo mechanism (Phase 17), they are independent | 03.5, 17         |

## Updated Top-Level Product Traceability

| PRD scope                                                                               | Requirements mapping                                 | Design mapping                        | Task phases        | Implementation focus                                                                                         |
| --------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------ |
| `20`                                                                                    | `8.0`                                                | `4.1.5`, `5.1.5`                      | 03.5               | System bootstrap mechanism for first organization and admin user creation                                    |
| `1.4`, `13.5.1` to `13.5.4`, `15.6.2`, `18.12`                                          | `3`, `4`, `5`, `11`, `12`, `15`, `16`                | `2`, `3`, `4`, `5`, `13`, `14`        | 00, 01, 02, 03, 18 | Repository conventions, constants policy, middleware contract, and cross-layer engineering rules             |
| `8.1`, `9.1`, `11.8`, `18.1`                                                            | `6.1`, `8.1`, `11`, `12`                             | `4`, `5`, `9.1`, `10`                 | 04                 | Identity, invitation, session lifecycle, and protected-route behavior                                        |
| `8.2`, `8.3`, `8.17`, `11.2` to `11.7`, `11.22`, `18.1`, `18.11`                        | `6.2`, `6.3`, `8.2`, `11`, `12`                      | `3`, `4`, `5`, `6`, `9.2`, `10`       | 05, 06             | Organizations, properties, locations, master data, roles, users, teams, and scoped access                    |
| `8.5`, `8.13`, `9.9`, `11.9`, `11.10`, `11.19`, `18.6`                                  | `6.5`, `8.4`, `11`, `12`                             | `4`, `5`, `6`, `8`, `9.3`, `10`       | 07                 | Assets, meters, documents, transfer and retirement workflows, and asset history                              |
